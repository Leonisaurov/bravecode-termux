...
HELPER = (
    ...
    '    const option_names = [_][]const u8{ "ndk-include", "ndk-arch-include" };\n'
    "    for (option_names) |name| {\n"
    '        const value = b.option([]const u8, name, "Include dir del NDK para translate-c en Android") orelse continue;\n'
